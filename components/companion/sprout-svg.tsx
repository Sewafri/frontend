...
const TONES: Record<Tone, Palette> = {
  original: {
    ...
    leaf: "#16a34a",
    leafDark: "#15803d",
    backpack: ["#c4a882", "#b89b72"],
    backpackStroke: "#a68b6e",
    backpackLight: "#d4c4a8",
    blush: "#fca5a5",
    eyes: "#784d3a",
    mouth: "#a16207",
    accent: "#2563eb",
  ...
  mint: {
    ...
    leaf: "#34d399",
    leafDark: "#059669",
    backpack: ["#86efac", "#4ade80"],
    backpackStroke: "#22c55e",
    backpackLight: "#bbf7d0",
    blush: "#fda4af",
    eyes: "#065f46",
    mouth: "#065f46",
    accent: "#8b5cf6",
  ...
  coral: {
    ...
    leaf: "#fb923c",
    leafDark: "#ea580c",
    backpack: ["#fdba74", "#fb923c"],
    backpackStroke: "#f97316",
    backpackLight: "#fed7aa",
    blush: "#fecaca",
    eyes: "#7c2d12",
    mouth: "#9a3412",
    accent: "#f59e0b",
  ...
  sky: {
    ...
    leaf: "#60a5fa",
    leafDark: "#2563eb",
    backpack: ["#93c5fd", "#60a5fa"],
    backpackStroke: "#3b82f6",
    backpackLight: "#dbeafe",
    blush: "#fbcfe8",
    eyes: "#1e3a5f",
    mouth: "#1e3a5f",
    accent: "#f97316",
  ...
  lavender: {
    ...
    leaf: "#a855f7",
    leafDark: "#7c3aed",
    backpack: ["#c4b5fd", "#a78bfa"],
    backpackStroke: "#8b5cf6",
    backpackLight: "#ede9fe",
    blush: "#fbcfe8",
    eyes: "#4c1d95",
    mouth: "#4c1d95",
    accent: "#34d399",
  ...
  rose: {
    ...
    leaf: "#fb7185",
    leafDark: "#e11d48",
    backpack: ["#fda4af", "#fb7185"],
    backpackStroke: "#f43f5e",
    backpackLight: "#ffe4e6",
    blush: "#fda4af",
    eyes: "#831843",
    mouth: "#9d174d",
    accent: "#fbbf24",
