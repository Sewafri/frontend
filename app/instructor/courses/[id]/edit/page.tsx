        ...
        <div className="space-y-6">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input type="text" defaultValue={course.title} className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-text-primary outline-none focus:border-brand-orange/50" />
            </div>
            <div className="sm:col-span-2">
            ...
            <div>
              ...
              <select defaultValue={course.category} className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-text-primary outline-none focus:border-brand-orange/50">
            ...
            <div>
              ...
              <select defaultValue={course.status} className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-text-primary outline-none focus:border-brand-orange/50">
                <option>Draft</option>
          ...
          <div className="flex justify-end gap-3 border-t border-border-glass pt-6">
            <Link href={`/instructor/courses/${params.id}/curriculum`} className="rounded-lg border border-border-glass px-4 py-2 text-sm font-medium text-text-secondary transition-colors hover:text-text-primary">Manage Curriculum</Link>
