      ...
      <form onSubmit={handleSubmit} className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full cursor-pointer rounded-xl border border-border-glass bg-surface-dark py-3.5 pl-12 pr-4 text-sm text-text-primary placeholder-text-secondary outline-none focus:border-brand-orange/50 focus:ring-1 focus:ring-brand-orange/20"
          />
        </div>
        <button
          type="submit"
          disabled={!certId.trim()}
          className="mt-4 w-full cursor-pointer rounded-xl bg-brand-orange py-3 font-medium text-text-primary transition-colors hover:bg-brand-orange/90 disabled:cursor-not-allowed disabled:opacity-50"
        >
          Verify Certificate
        </button>
      </form>
