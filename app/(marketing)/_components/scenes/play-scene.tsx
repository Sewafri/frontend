  ...
  return (
    <div className={cn("relative flex flex-col items-center py-10 select-none", className)}>
        ...
        >
          ...
          {celebrate && (
            <svg width="16" height="16" viewBox="0 0 16 16" className="holo absolute -top-2 -right-3">
              <path d="M8 2 L8.8 5.2 L12 6 L8.8 6.8 L8 10 L7.2 6.8 L4 6 L7.2 5.2 Z" fill="#94a3b8" stroke="#475569" strokeWidth="0.8" />
              <path d="M4 1 L4.4 2.8 L6.2 3.2 L4.4 3.6 L4 5.4 L3.6 3.6 L1.8 3.2 L3.6 2.8 Z" fill="#94a3b8" stroke="#334155" strokeWidth="0.5" opacity="0.6" />
            </svg>
          )}
        </motion.div>
      ...
      <style>{`
        ...
        .holo {
          filter: drop-shadow(0 0 3px rgba(148,163,184,.5)) drop-shadow(0 0 8px rgba(148,163,184,.25));
          opacity: .75;
        }
      `}</style>
    </div>
