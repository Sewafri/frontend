          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input type="text" placeholder="Dr. Sarah Wilson" className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-white placeholder-text-secondary outline-none focus:border-brand-orange/50" />
              </div>
              <div>
                <label className="mb-1.5 block text-xs font-medium text-text-secondary">Email</label>
                <input type="email" placeholder="sarah@example.com" className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-white placeholder-text-secondary outline-none focus:border-brand-orange/50" />
              </div>
            </div>
          </div>

          <div className="border-t border-border-glass pt-6">
            <h3 className="mb-4 text-sm font-semibold text-white">Expertise &amp; Experience</h3>
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
            ...
            <div className="mt-4">
              ...
              <textarea rows={5} placeholder="Tell us about your teaching experience and philosophy..." className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-white placeholder-text-secondary outline-none focus:border-brand-orange/50" />
            </div>
          </div>

          <div className="flex justify-end border-t border-border-glass pt-6">
            <button onClick={() => setSubmitted(true)} className="cursor-pointer flex items-center gap-2 rounded-lg bg-brand-orange px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-brand-orange/90">
