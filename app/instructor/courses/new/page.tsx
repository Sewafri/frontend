        ...
        <div className="space-y-6">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input type="text" placeholder="e.g., Advanced React Patterns" className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-white placeholder-text-secondary outline-none focus:border-brand-orange/50" />
            </div>
            <div className="sm:col-span-2">
              <label className="mb-1.5 block text-xs font-medium text-text-secondary">Description</label>
              <textarea rows={4} placeholder="Describe what students will learn..." className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-white placeholder-text-secondary outline-none focus:border-brand-orange/50" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="number" placeholder="49" className="w-full rounded-lg border border-border-glass bg-surface-card px-3 py-2.5 text-sm text-white placeholder-text-secondary outline-none focus:border-brand-orange/50" />
            </div>
            <div>
          ...
          <div className="flex justify-end gap-3 border-t border-border-glass pt-6">
            <Link href="/instructor/courses" className="rounded-lg border border-border-glass px-4 py-2 text-sm font-medium text-text-secondary transition-colors hover:text-white">Cancel</Link>
