...
function PhoneGlow() {
  return (
    <motion.div
      className="absolute -inset-3 rounded-2xl bg-sky-400/10 blur-md"
...
export default function ScrollScene({ className }: ScrollSceneProps) {
  ...
  return (
    <div className={cn("relative flex flex-col items-center py-10 select-none", className)}>
      ...
      <div className="relative mb-1">
        ...
        >
          <svg width="28" height="40" viewBox="0 0 28 40">
            ...
            <rect x="4" y="4" width="20" height="28" rx="2" fill="#60a5fa" />
            {/* Screen content */}
            <motion.g
              animate={{ opacity: [0.3, 0.6, 0.3] }}
              transition={{ duration: 2, repeat: Infinity }}
            >
              <rect x="6" y="6" width="16" height="2" rx="1" fill="#93c5fd" opacity={0.6} />
              <rect x="6" y="10" width="12" height="1.5" rx="0.75" fill="#93c5fd" opacity={0.4} />
              <rect x="6" y="13" width="14" height="1.5" rx="0.75" fill="#93c5fd" opacity={0.4} />
              <rect x="6" y="17" width="16" height="2" rx="1" fill="#93c5fd" opacity={0.5} />
              <rect x="6" y="21" width="10" height="1.5" rx="0.75" fill="#93c5fd" opacity={0.4} />
              <rect x="6" y="25" width="14" height="1.5" rx="0.75" fill="#93c5fd" opacity={0.4} />
            </motion.g>
            {/* Home indicator */}
      ...
      <motion.div
        className="h-1 w-16 rounded-full bg-sky-300/20 blur-[2px]"
